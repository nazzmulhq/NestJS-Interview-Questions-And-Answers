...
1. `Method decorators` যেমন `@Get()`, `@Post()`, `@Put()`, ইত্যাদি। এগুলো কন্ট্রোলার ক্লাসের মধ্যে নির্দিষ্ট রুট পরিচালনার জন্য মেথড অ্যানোটেট করতে ব্যবহৃত হয়।
1. `Parameter decorators` যেমন `@Req()`, `@Res()`, `@Body()`, ইত্যাদি। এগুলো রুট হ্যান্ডলিং মেথডের মধ্যে প্যারামিটার অ্যানোটেট করতে ব্যবহৃত হয়।
1. `Property decorators` যেমন `@Inject()`। এগুলো ক্লাসের মধ্যে প্রপার্টি অ্যানোটেট করতে ব্যবহৃত হয়।
1. `Custom decorators`। আপনি আপনার অ্যাপ্লিকেশন জুড়ে সাধারণ কাজ পরিচালনা করতে আপনার নিজস্ব ডেকোরেটর তৈরি করতে পারেন।
...
1. Access token expire হলে client refresh token পাঠায়
1. সার্ভার refresh token যাচাই করে নতুন access token দেয়
1. Refresh token ডাটাবেসে সংরক্ষণ করা হয়
~~~ typescript
...
1. উভয়ই abstractions এর উপর নির্ভর করবে
...
1. পরিবর্তন commit করুন
1. Pull request পাঠান
